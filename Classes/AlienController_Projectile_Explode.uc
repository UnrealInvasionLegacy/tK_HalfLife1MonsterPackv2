class AlienController_Projectile_Explode extends HalfLife_Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'tk_HalfLife1MonsterPackv2.AlienController_Projectile_Explode.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         StartVelocityRadialRange=(Max=4.000000)
         GetVelocityDirectionFrom=PTVD_AddRadial
         VelocityScale(0)=(RelativeVelocity=(X=10.000000,Y=10.000000,Z=10.000000))
         VelocityScale(1)=(RelativeTime=0.500000)
     End Object
     Emitters(1)=SpriteEmitter'tk_HalfLife1MonsterPackv2.AlienController_Projectile_Explode.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         VelocityScale(0)=(RelativeVelocity=(X=1.000000,Y=1.000000,Z=3.000000))
         VelocityScale(1)=(RelativeTime=0.500000,RelativeVelocity=(X=10.000000,Y=10.000000,Z=10.000000))
         WarmupTicksPerSecond=2.000000
         RelativeWarmupTime=1.000000
     End Object
     Emitters(2)=SpriteEmitter'tk_HalfLife1MonsterPackv2.AlienController_Projectile_Explode.SpriteEmitter6'
